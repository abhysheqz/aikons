...
> = ({ size = 24, ...props }) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M13 22.25a.75.75 0 0 0 0-1.5zm8.25-11.75a.75.75 0 0 0-1.5 0zm-1.5 2a.75.75 0 0 0 1.5 0zm-17-2v9h1.5v-9zM5.5 22.25H13v-1.5H5.5zM19.75 10.5v2h1.5v-2zm-17 9a2.75 2.75 0 0 0 2.75 2.75v-1.5c-.69 0-1.25-.56-1.25-1.25z"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
