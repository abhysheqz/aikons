  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M20.5 16c.95.601 1.5 1.31 1.5 2.07C22 20.24 17.523 22 12 22S2 20.24 2 18.07c0-.76.55-1.469 1.5-2.07M12 4a2 2 0 1 1 0 4 2 2 0 0 1 0-4m0 0c0-.5.4-1.6 2-2"
      />
    </svg>
  );
};
