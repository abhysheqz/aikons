...
> = ({ size = 24, ...props }) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M10.5 21.25a.75.75 0 0 0 0 1.5zm4 1.5a.75.75 0 0 0 0-1.5zM11.75 19v3h1.5v-3zm-1.25 3.75h4v-1.5h-4z"
      />
      <circle
        cx={7}
        cy={7}
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M6.5 2a9.85 9.85 0 0 0-3 7.083C3.5 14.56 7.977 19 13.5 19a10 10 0 0 0 7-2.835"
      />
    </svg>
  );
};
