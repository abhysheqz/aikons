  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M10.808 6a3.005 3.005 0 0 1-3.807 3.808m12.735.427c3.326 3.326 2.614 6.42.266 8.767-2.347 2.348-5.441 3.06-8.767-.266S5.611 9.306 7.96 6.96c2.347-2.348 8.452-.05 11.777 3.276"
      />
    </svg>
  );
};
