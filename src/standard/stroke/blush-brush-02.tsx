  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth={1.5}
        d="m6.086 3.994.331.896A3 3 0 0 0 8.19 6.663l.896.331-.896.332a3 3 0 0 0-1.773 1.772l-.331.896-.332-.896a3 3 0 0 0-1.772-1.772l-.896-.332.896-.331A3 3 0 0 0 5.754 4.89zM15.039 14.995c-.601 4.866-3.608 6.75-4.98 7.008-2.631-.348-4.351-1.637-5.429-3.14m10.409-3.868-3.021-2.017m3.02 2.017 2.559-5m-5.58 2.983c-4.06 2.733-7.359 1.66-8.873.9a.098.098 0 0 0-.143.084c-.02 1.21.432 3.229 1.63 4.9m7.387-5.884 3.006-4.594m0 0 3.834-5.86c.331-.5.986-.669 1.516-.39.571.3.792 1.008.492 1.58l-3.27 6.28m-2.572-1.61 2.573 1.61M4.63 18.862c2.092.623 4.767-.397 5.542-.91"
      />
    </svg>
  );
};
