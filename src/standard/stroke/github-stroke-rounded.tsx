...
const GithubStrokeRounded: React.FC<
  {
  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth={1.5}
        d="M10 20.568c-3.429 1.157-6.286 0-8-3.568"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
