...
const LaurelWreathRight_01: React.FC<
  {
  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth={1.5}
        d="M11.697 21.657C10.041 22.51 8 21.506 8 21.506s.646-2.312 2.303-3.163c1.656-.852 3.697.151 3.697.151s-.646 2.312-2.303 3.163Z"
      />
      <path
        stroke="currentColor"
        strokeLinejoin="round"
...
export default LaurelWreathRight_01;
