  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M10.5 8.5H10a1 1 0 0 0-1 1v.5m1.5-1.5V7m0 1.5h3m0-1.5v1.5m0 0h.5a1 1 0 0 1 1 1v.5m-1.5 4.5h.5a1 1 0 0 0 1-1V13m-1.5 1.5V16m0-1.5h-3m0 0H10a1 1 0 0 1-1-1V13m1.5 1.5V16M9 13H7.5M9 13v-3m0 0H7.5m7.5 0h1.5M15 10v3m0 0h1.5"
      />
    </svg>
  );
};
