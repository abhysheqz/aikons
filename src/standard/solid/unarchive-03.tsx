  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M4.785 3.42a2.93 2.93 0 0 1 2.34-1.17h9.75c.92 0 1.788.433 2.34 1.17l2.34 3.12a.98.98 0 0 1 .195.585v11.7a2.925 2.925 0 0 1-2.925 2.925H5.175a2.925 2.925 0 0 1-2.925-2.925v-11.7c0-.211.068-.416.195-.585zm2.34.779a.98.98 0 0 0-.78.39l-1.17 1.56h13.65l-1.17-1.56a.98.98 0 0 0-.78-.39zM13 17.499a1 1 0 0 1-2 0v-4.585l-1.293 1.293a1 1 0 0 1-1.414-1.414l3-3a1 1 0 0 1 1.414 0l3 3a1 1 0 0 1-1.414 1.414L13 12.914z"
        clipRule="evenodd"
      />
    </svg>
  );
