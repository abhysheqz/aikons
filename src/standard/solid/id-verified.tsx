  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M17.5 13.25a4.75 4.75 0 1 0 0 9.5 4.75 4.75 0 0 0 0-9.5m2.03 4.28a.75.75 0 1 0-1.06-1.06L17 17.94l-.47-.47a.75.75 0 1 0-1.06 1.06l1 1a.75.75 0 0 0 1.06 0z"
        clipRule="evenodd"
      />
    </svg>
  );
