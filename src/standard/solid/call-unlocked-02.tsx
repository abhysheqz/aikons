...
> = ({ size = 24, ...props }) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M16.75 3.5c-.69 0-1.25.56-1.25 1.25v.75h3.75c.966 0 1.75.784 1.75 1.75v2.5a1.75 1.75 0 0 1-1.75 1.75h-5a1.75 1.75 0 0 1-1.75-1.75v-2.5A1.75 1.75 0 0 1 14 5.518V4.75a2.75 2.75 0 0 1 4.812-1.82.75.75 0 1 1-1.124.993 1.25 1.25 0 0 0-.938-.423"
      />
      <path
        fill="currentColor"
