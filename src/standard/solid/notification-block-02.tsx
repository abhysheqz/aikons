...
> = ({ size = 24, ...props }) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M13.012 2.32a5.5 5.5 0 0 0 6.238 8.396v4.091c0 1.32.803 2.507 2.029 2.997A.75.75 0 0 1 21 19.25H3a.75.75 0 0 1-.278-1.446 3.23 3.23 0 0 0 2.028-2.997V9.5a7.25 7.25 0 0 1 8.262-7.18"
      />
    </svg>
  );
};
