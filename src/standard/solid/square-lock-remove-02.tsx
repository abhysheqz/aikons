  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M17 13.25a4.75 4.75 0 1 0 0 9.5 4.75 4.75 0 0 0 0-9.5m-.47 3.22a.75.75 0 0 0-1.06 1.06l.468.47-.469.47a.75.75 0 0 0 1.062 1.06l.468-.47.471.47a.75.75 0 0 0 1.06-1.06l-.47-.47.47-.47a.75.75 0 0 0-1.06-1.06l-.47.47z"
        clipRule="evenodd"
      />
    </svg>
  );
