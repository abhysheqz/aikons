...
> = ({ size = 24, ...props }) => {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M13.448 12.357A6.24 6.24 0 0 0 10.75 17.5c0 .608.087 1.195.248 1.75H4a1.75 1.75 0 0 1-1.75-1.75v-1.03c0-1.436.65-2.984 2.129-3.658C5.86 12.136 7.62 11.75 9.5 11.75c1.404 0 2.742.216 3.948.607"
      />
    </svg>
  );
};
