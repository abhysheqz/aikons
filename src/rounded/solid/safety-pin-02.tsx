  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M7.307 4.049a1 1 0 0 1 .645 1.258l-4 12.41a1 1 0 1 1-1.904-.613l4-12.41a1 1 0 0 1 1.259-.645m10.45 7.297a1 1 0 0 1-.103 1.41l-10.41 9a1 1 0 1 1-1.308-1.512l10.41-9a1 1 0 0 1 1.41.102"
        clipRule="evenodd"
      />
    </svg>
  );
