  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M1 20a1 1 0 0 1 1-1h20a1 1 0 1 1 0 2H2a1 1 0 0 1-1-1M3 1a1 1 0 0 1 1 1c0 3.992.973 7.558 2.494 10.092C8.026 14.646 10.004 16 12 16s3.974-1.354 5.506-3.908C19.028 9.558 20 5.992 20 2a1 1 0 1 1 2 0c0 4.292-1.042 8.227-2.779 11.121C17.498 15.996 14.975 18 12 18s-5.497-2.004-7.221-4.879C3.042 10.226 2 6.292 2 2a1 1 0 0 1 1-1"
        clipRule="evenodd"
      />
      <path
        fill="currentColor"
