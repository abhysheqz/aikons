  ...
  return (
    ...
    >
      ...
      <path
        stroke="currentColor"
        strokeWidth={1.5}
        d="M12 7.5c0-.466 0-.699-.076-.883a1 1 0 0 0-.541-.54C11.199 6 10.966 6 10.5 6s-.699 0-.883.076a1 1 0 0 0-.54.541C9 6.801 9 7.034 9 7.5v1c0 .466 0 .699.076.883a1 1 0 0 0 .541.54c.184.077.417.077.883.077s.699 0 .883-.076a1 1 0 0 0 .54-.541C12 9.199 12 8.966 12 8.5z"
      />
    </svg>
  );
};
