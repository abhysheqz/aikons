  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M15.022 10.234c-.043-.58-.371-1.985-1.633-2.504-1.576-.649-3.653.168-3.847 2.271-.091.987.42 2.022 1.163 2.533.682.47 1.718.446 2.684.446H8.026m3.24 0c-.182.69-1.18 2.671-2.77 3.499h5.786c.224 0 .856.054 1.75-.546"
      />
    </svg>
  );
};
