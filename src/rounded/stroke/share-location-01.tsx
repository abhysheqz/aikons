  ...
  return (
    ...
    >
      ...
      <path
        stroke="currentColor"
        strokeWidth={1.5}
        d="M12.719 16.215a1.044 1.044 0 0 1-1.437 0c-1.765-1.683-4.13-3.564-2.977-6.294C8.929 8.445 10.425 7.5 12 7.5s3.072.945 3.695 2.42c1.152 2.728-1.207 4.618-2.976 6.295Z"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
