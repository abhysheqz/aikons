  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth={1.5}
        d="M10 6C6.229 6 4.343 6 3.172 7.172S2 10.229 2 14s0 5.657 1.172 6.828S6.229 22 10 22h4c3.771 0 5.657 0 6.828-1.172S22 17.771 22 14c0-1.17 0-2.158-.035-3"
      />
      <path
        stroke="currentColor"
        strokeLinejoin="round"
