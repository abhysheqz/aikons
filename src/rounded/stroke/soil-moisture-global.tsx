  ...
  return (
    ...
    >
      <path
        stroke="currentColor"
        strokeWidth={1.5}
        d="M17 19.503c0-1.255 1.053-2.495 1.792-3.211a1.004 1.004 0 0 1 1.416 0c.739.716 1.792 1.956 1.792 3.211C22 20.734 21.053 22 19.5 22S17 20.734 17 19.503Z"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
