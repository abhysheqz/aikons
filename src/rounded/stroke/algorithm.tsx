  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth={1.5}
        d="M10.5 2v2m3-2v2M8 6.5H6m2 3H6m12-3h-2m2 3h-2M13.333 4h-2.666C9.41 4 8.78 4 8.39 4.39 8 4.782 8 5.41 8 6.668v2.666c0 1.257 0 1.886.39 2.277.391.39 1.02.39 2.277.39h2.666c1.257 0 1.886 0 2.277-.39.39-.391.39-1.02.39-2.277V6.667c0-1.257 0-1.886-.39-2.276C15.219 4 14.59 4 13.333 4"
      />
      <path
        stroke="currentColor"
        strokeLinejoin="round"
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M12 19v-7M4.5 19c0-1.404 0-2.107.337-2.611a2 2 0 0 1 .552-.552C5.893 15.5 6.596 15.5 8 15.5h8c1.404 0 2.107 0 2.611.337.218.146.406.334.552.552.337.504.337 1.207.337 2.611"
      />
      <path
        stroke="currentColor"
        strokeLinejoin="round"
