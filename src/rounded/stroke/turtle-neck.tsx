  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M6.5 10c.166.997.376 1.996.46 3.003.19 2.312.04 4.68.04 6.997 0 1.655.345 2 2 2h6c1.655 0 2-.345 2-2 0-2.317-.15-4.685.04-6.997.084-1.007.294-2.006.46-3.003M9 5a5 5 0 0 0 6 0"
      />
    </svg>
  );
};
