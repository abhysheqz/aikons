  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M9.842 12.659c-.673.79-2.039 1.768-1.796 2.233m0 0c-.135.473 1.188 1.41 1.799 2.124m-1.799-2.124c2.756.056 4.441-.26 6.069-1.794 1.694-1.6 2.01-3.325 1.873-6.093"
      />
    </svg>
  );
};
