  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M11 16c.793.66 1.206.674 2 0"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth={2}
        d="M9 12.5h-.009M15.008 12.5h-.009"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M5.108 14.023c1.254.402 3.085 2.708.677 4.915M18.893 14.043c-1.254.401-3.085 2.708-.677 4.915"
      />
    </svg>
  );
};
