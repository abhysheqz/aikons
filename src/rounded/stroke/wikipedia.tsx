  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M5 8h1.05m0 0H7m-.95 0 2.577 6.82C9.177 16.275 9.451 17 9.9 17c.45 0 .724-.726 1.273-2.18L13.75 8h.75m-5 0h.75l2.577 6.82c.55 1.454.824 2.18 1.273 2.18.45 0 .724-.726 1.273-2.18L17.95 8m0 0H17m.95 0H19"
      />
    </svg>
  );
};
