  ...
  return (
    ...
    >
      <path
        ...
        strokeLinecap="round"
        strokeWidth={1.5}
        d="M7 7.94c0 2.194.923 7.083 3.387 9.636.536.555 1.379.566 1.931.028 1.074-1.046 2.217-2.716 2.995-4.441m0 0c-3.18-.854-3.284-3.274-2.813-4.608 1.158-2.766 3.763-1.455 3.763.921 0 .438-.058.906-.165 1.39m-.785 2.297c.726.194 1.611.307 2.687.307"
      />
      <path
        stroke="currentColor"
