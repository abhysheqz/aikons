  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M12 11.099c-1.313.9-2.901 2.68-3.5 5.401m.875-2.396c-2.072-4.794 2.108-6.411 5.289-6.591.384-.022.576-.033.713.107.138.14.13.34.114.738-.131 3.316-1.453 7.878-6.116 5.746"
      />
    </svg>
  );
};
