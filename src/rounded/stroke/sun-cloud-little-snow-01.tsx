  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M17.478 9.01h.022c2.485 0 4.5 2.017 4.5 4.506 0 1.962-1.252 3.365-3 3.984m-1.522-8.49q.021-.249.022-.502A5.504 5.504 0 0 0 12 3a5.504 5.504 0 0 0-5.48 5.03m10.958.98a5.5 5.5 0 0 1-1.235 3.004M6.52 8.03A5.005 5.005 0 0 0 2 13.015C2 15.07 3.234 16.71 5 17.5m1.52-9.47q.237-.022.48-.022c1.126 0 2.165.372 3 1.001M11 16l1 1m0 0 1 1m-1-1 1-1m-1 1-1 1m4 2 1 1m0 0 1 1m-1-1 1-1m-1 1-1 1m-8-2 1 1m0 0 1 1m-1-1 1-1m-1 1-1 1"
      />
    </svg>
  );
};
