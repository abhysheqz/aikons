  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M11.55 15.105c-.771.66-1.864 1.995-2.317 1.86m0 0c-.528 0-1.536-1.31-2.274-1.86m2.274 1.86c.154-2.392-.32-5.472.688-6.728 1.119-1.32 4.298-.839 7.112-.971m0 0c.06.666-1.241 1.527-1.915 2.285m1.915-2.285c.123-.443-1.27-1.576-1.912-2.24"
      />
    </svg>
  );
};
