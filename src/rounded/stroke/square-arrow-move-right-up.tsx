  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M14.175 11.352c.672-.79 2.038-1.769 1.795-2.233m0 0c.135-.474-1.187-1.41-1.798-2.124m1.798 2.124c-2.755-.057-4.441.259-6.068 1.794-1.695 1.599-2.01 3.324-1.873 6.092"
      />
    </svg>
  );
};
