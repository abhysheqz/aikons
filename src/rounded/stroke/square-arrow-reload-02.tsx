  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M16.5 11.546c0-1.647-.032-2.273-1.8-2.273H8.74c-.953 0-1.062-.225-.47-.973L9.3 7m-1.8 5.454c0 1.647.032 2.273 1.8 2.273h5.96c.953 0 1.062.226.47.973L14.7 17"
      />
    </svg>
  );
};
