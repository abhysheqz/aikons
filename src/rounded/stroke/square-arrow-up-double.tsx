  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M16 10.833 13.886 8.79C12.996 7.93 12.552 7.5 12 7.5s-.997.43-1.886 1.29L8 10.832m8 5.667-2.114-2.044c-.89-.86-1.334-1.29-1.886-1.29s-.997.43-1.886 1.29L8 16.5"
      />
    </svg>
  );
};
