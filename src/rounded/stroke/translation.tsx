  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth={1.5}
        d="M5 5.966h3.15m3.85 0h-1.75m-2.1 0h2.1m-2.1 0V5m2.1.966c-.37 1.32-1.142 2.568-2.025 3.665M5.975 12c.713-.656 1.52-1.46 2.25-2.369m0 0c-.45-.528-1.08-1.381-1.26-1.767m1.26 1.767 1.35 1.403"
      />
      <path
        stroke="currentColor"
        strokeWidth={1.5}
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="m13 19 .833-2M18 19l-.833-2m-3.334 0 1.667-4 1.667 4m-3.334 0h3.334"
      />
    </svg>
  );
};
