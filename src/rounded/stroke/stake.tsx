  ...
  return (
    ...
    >
      <path
        stroke="currentColor"
        strokeWidth={1.5}
        d="M8 6c3.314 0 6-.895 6-2s-2.686-2-6-2-6 .895-6 2 2.686 2 6 2Z"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M2 4v8.043c0 .704 1.178 1.59 4.13 1.957M2.107 8.548C3.312 9.61 5.46 10.06 7.754 10.06m6.234-5.939v2.015"
      />
    </svg>
  );
};
