  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M5.033 20C4.545 14.6 9 13.5 11 11m.034 4.835c2.545-.71 4.177-2.413 4.782-4.987.686-2.915-.543-6.885-3.713-6.848 0 0 .322 1.26.04 1.876-1.04 2.275-4.643 2.117-5.81 5-.696 1.615-.275 3.418 1.033 4.452.822.65 2.446.849 3.668.507"
      />
    </svg>
  );
};
