  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M16 9c-3.184 0-4.816 6.02-8 6.02"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M15.54 15.02c-.808 0-1.252 0-1.593-.12a1.8 1.8 0 0 1-.52-.284c-.265-.21-.41-.509-.7-1.108l-1.452-2.995c-.29-.6-.435-.9-.7-1.108a1.8 1.8 0 0 0-.52-.284C9.715 9 9.27 9 8.461 9"
      />
    </svg>
  );
};
