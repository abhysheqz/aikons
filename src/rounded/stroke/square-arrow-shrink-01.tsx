  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M11.017 11.017c.575-.575.479-3.017.479-3.017m-.48 3.017c-.574.575-3.016.479-3.016.479m3.017-.48L7 7m5.987 5.987c.575-.575 3.017-.48 3.017-.48m-3.017.48c-.575.575-.48 3.016-.48 3.016m.48-3.016L17 17"
      />
    </svg>
  );
};
