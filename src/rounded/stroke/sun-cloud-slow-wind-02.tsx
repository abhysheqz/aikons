  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M17.478 10.9h.022c2.485 0 4.5 1.982 4.5 4.426 0 1.168-.46 2.383-1.21 3.174m-3.312-7.6q.021-.242.022-.491C17.5 7.422 15.038 5 12 5 9.123 5 6.762 7.172 6.52 9.94m10.958.96a5.34 5.34 0 0 1-1.235 2.951M6.52 9.94C3.984 10.177 2 12.278 2 14.835c0 1.375.574 2.773 1.5 3.665m3.02-8.56q.237-.023.48-.023c1.126 0 2.165.366 3 .984"
      />
    </svg>
  );
};
