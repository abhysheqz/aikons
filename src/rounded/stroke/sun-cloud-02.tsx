  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth={1.5}
        d="M2.96 10.194c-.741-2.722.9-5.52 3.664-6.25m-3.665 6.25L2 10.447m.96-.253c.184.677.498 1.285.908 1.806m2.756-8.055L6.367 3m.257.945A5.23 5.23 0 0 1 12 5.67m-8.523.653-1.013-.577m8.677-2.289-.584.998"
      />
    </svg>
  );
};
