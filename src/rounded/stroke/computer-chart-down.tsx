  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="m16 12-2.5-2.5c-.273-.273-.409-.409-.556-.482a1 1 0 0 0-.888 0c-.147.073-.283.21-.556.482-.273.273-.409.409-.556.482a1 1 0 0 1-.888 0c-.147-.073-.283-.21-.556-.482L7 7m10 3v1.714c0 .606 0 .91-.188 1.098-.189.188-.492.188-1.098.188H14"
      />
    </svg>
  );
};
