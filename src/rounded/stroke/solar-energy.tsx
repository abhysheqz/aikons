  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M15 12a3 3 0 0 1-3 3m3-3a3 3 0 0 0-3-3m3 3h1.5M12 15a3 3 0 0 1-3-3m3 3v1.5M9 12a3 3 0 0 1 3-3m-3 3H7.5M12 9V7.5m2.121 2.379 1.061-1.061m-5.303 5.303-1.061 1.061m5.303-1.06 1.061 1.06M9.879 9.879 8.818 8.818"
      />
    </svg>
  );
};
