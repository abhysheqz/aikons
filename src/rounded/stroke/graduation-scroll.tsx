  ...
  return (
    ...
    >
      ...
      <path
        stroke="currentColor"
        strokeWidth={1.5}
        d="M15 13.607c-1.362-.573-4.077-2.656-4.043-6.406m.543 8.5c-1.167-.557-3.6-2.622-4-6.431"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
        ...
        strokeWidth={1.5}
        d="M15.43 14c.598 1.13 1.209 4.112-.88 7l-.987-1.416L11 20.81s1.825-1.923.953-4.81"
      />
    </svg>
  );
};
