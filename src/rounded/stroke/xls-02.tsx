  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M13.5 14v3c0 .943 0 1.414.293 1.707S14.557 19 15.5 19M8 14l1.5 2.5m0 0L11 19m-1.5-2.5L11 14m-1.5 2.5L8 19M20.5 14H19a1 1 0 0 0-1 1v.5a1 1 0 0 0 1 1h.5a1 1 0 0 1 1 1v.5a1 1 0 0 1-1 1H18"
      />
    </svg>
  );
};
