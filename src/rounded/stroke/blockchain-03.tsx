  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="m13.19 21.576 4.694-2.272C19.961 18.3 21 17.796 21 17V7c0-.796-1.039-1.299-3.116-2.304L13.19 2.424C12.606 2.141 12.314 2 12 2s-.606.141-1.19.424L6.116 4.696C4.039 5.7 3 6.204 3 7v10c0 .796 1.039 1.299 3.116 2.304l4.694 2.272c.584.283.876.424 1.19.424s.606-.141 1.19-.424Z"
      />
    </svg>
  );
};
