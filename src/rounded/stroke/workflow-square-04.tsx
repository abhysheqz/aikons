  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M9 9h3c2.828 0 4.243 0 5.121.879C18 10.757 18 12.172 18 15M6 12v10M6 6V2"
      />
    </svg>
  );
};
