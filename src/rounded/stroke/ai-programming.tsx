  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="m15.5 12 1.227 1.057c.515.445.773.667.773.943s-.258.498-.773.943L15.5 16M7.5 12l-1.227 1.057c-.515.445-.773.667-.773.943s.258.498.773.943L7.5 16M12.5 11l-2 6"
      />
    </svg>
  );
};
