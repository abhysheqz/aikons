  ...
  return (
    ...
    >
      ...
      <path
        stroke="currentColor"
        strokeWidth={1.5}
        d="M9.5 18.503c0-1.255 1.053-2.495 1.792-3.211a1.004 1.004 0 0 1 1.416 0c.739.716 1.792 1.956 1.792 3.211C14.5 19.734 13.553 21 12 21s-2.5-1.266-2.5-2.497Z"
      />
    </svg>
  );
};
