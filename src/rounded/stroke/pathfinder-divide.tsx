  ...
  return (
    ...
    >
      <path
        stroke="currentColor"
        strokeWidth={1.5}
        d="M2 8.5c0-2.816 0-4.225.764-5.182a3.5 3.5 0 0 1 .554-.554C4.275 2 5.684 2 8.5 2s4.225 0 5.182.764q.309.245.554.554C15 4.275 15 5.684 15 8.5s0 4.225-.764 5.182a3.5 3.5 0 0 1-.554.554C12.725 15 11.316 15 8.5 15s-4.225 0-5.182-.764a3.5 3.5 0 0 1-.554-.554C2 12.725 2 11.316 2 8.5Z"
      />
      <path
        stroke="currentColor"
        strokeWidth={1.5}
