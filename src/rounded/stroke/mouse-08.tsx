  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M13 9V7.5c0-1.886 0-2.828-.586-3.414S10.886 3.5 9 3.5H6.5A1.5 1.5 0 0 1 5 2"
      />
      <path
        stroke="currentColor"
        strokeWidth={1.5}
        d="M11.5 10.5c0-.466 0-.699.076-.883a1 1 0 0 1 .541-.54C12.301 9 12.534 9 13 9s.699 0 .883.076a1 1 0 0 1 .54.541c.077.184.077.417.077.883v1c0 .466 0 .699-.076.883a1 1 0 0 1-.541.54C13.699 13 13.466 13 13 13s-.699 0-.883-.076a1 1 0 0 1-.54-.541c-.077-.184-.077-.417-.077-.883z"
      />
    </svg>
  );
};
