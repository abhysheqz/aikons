  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="m19.5 18-.586.554c-.667.63-1 .946-1.414.946m-2-1.5.586.554c.667.63 1 .946 1.414.946m0 0v-4M16 5.5l-.1-.31c-.494-1.54-.742-2.31-1.331-2.75C13.979 2 13.197 2 11.632 2h-.264c-1.565 0-2.348 0-2.937.44-.59.44-.837 1.21-1.332 2.75L7 5.5"
      />
    </svg>
  );
};
