  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M12.983 11.017C12.408 10.442 12.504 8 12.504 8m.48 3.017c.574.575 3.016.479 3.016.479m-3.017-.48L17 7m-5.987 5.987c-.575-.575-3.017-.48-3.017-.48m3.017.48c.575.575.48 3.016.48 3.016m-.48-3.016L7 17"
      />
    </svg>
  );
};
