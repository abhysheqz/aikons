  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M8 9.241h4m4 0h-1.429m-2.571 0h2.571m-2.571 0V8m2.571 1.241c-.469 1.698-1.45 3.303-2.571 4.713M9.143 17c.906-.843 1.929-1.878 2.857-3.046m0 0c-.571-.678-1.371-1.776-1.6-2.272m1.6 2.272 1.714 1.805"
      />
    </svg>
  );
};
