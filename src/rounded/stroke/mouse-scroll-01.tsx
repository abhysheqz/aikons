  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M11.988 6.84v4.92M10.004 7.86c.982-1.02 1.58-1.92 2.036-1.855.383-.003.742.595 1.964 1.855M13.996 11.142c-.982 1.02-1.58 1.92-2.036 1.855-.383.004-.742-.595-1.964-1.855"
      />
    </svg>
  );
};
