  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="m7.016 9-.184-1.293c-.378-2.655-.567-3.983.178-4.845S9.092 2 11.766 2h.468c2.674 0 4.01 0 4.756.862.745.862.556 2.19.178 4.845L16.984 9"
      />
    </svg>
  );
};
