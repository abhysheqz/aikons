  ...
  return (
    ...
    >
      <path
        ...
        strokeLinecap="round"
        strokeWidth={1.5}
        d="M21 20c-.643-1.287-2-2.976-2-4.472 0-1.699.367-3.794-.422-5.373-.334-.666-.578-1.341-.578-2.1V4.43A.43.43 0 0 0 17.571 4 2.57 2.57 0 0 0 15 6.571M8 18l3.635 2.272c.24.15.446.35.604.586L13 22"
      />
      <path
        stroke="currentColor"
