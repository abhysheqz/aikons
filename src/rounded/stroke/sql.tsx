  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth={1.5}
        d="M8.415 10A1.5 1.5 0 1 0 7 12a1.5 1.5 0 1 1-1.415 2M12.5 15a1.5 1.5 0 0 1-1.5-1.5v-3a1.5 1.5 0 0 1 3 0v3a1.5 1.5 0 0 1-1.5 1.5Zm0 0 1.5 1.5M16.5 9v4c0 .943 0 1.414.293 1.707S17.557 15 18.5 15"
      />
    </svg>
  );
};
