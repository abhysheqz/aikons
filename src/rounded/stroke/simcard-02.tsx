  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={1.5}
        d="M7 14.5c0 1.65 0 2.475.44 2.987C7.878 18 8.585 18 10 18h4c1.414 0 2.121 0 2.56-.513.44-.512.44-1.337.44-2.987m-10 0c0-1.65 0-2.475.44-2.987C7.878 11 8.585 11 10 11h4c1.414 0 2.121 0 2.56.513.44.512.44 1.337.44 2.987m-10 0h2m8 0h-2"
      />
    </svg>
  );
};
