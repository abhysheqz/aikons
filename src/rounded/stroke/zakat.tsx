  ...
  return (
    ...
    >
      <path
        stroke="currentColor"
        strokeWidth={1.5}
        d="M19.468 10.355c-.364-2.022-1.5-3.528-2.486-4.413-.287-.257-.431-.386-.748-.505s-.59-.119-1.135-.119H13.9c-.545 0-.818 0-1.135.12-.317.118-.46.247-.748.504-.986.885-2.122 2.39-2.486 4.413C9.26 11.86 10.766 13 12.449 13h4.102c1.683 0 3.189-1.14 2.917-2.645Z"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
