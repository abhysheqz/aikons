  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
        strokeWidth={1.5}
        d="M17.5 15.875c-.828 0-1.5.588-1.5 1.313 0 .724.672 1.312 1.5 1.312s1.5.588 1.5 1.313c0 .724-.672 1.312-1.5 1.312m0-5.25c.653 0 1.209.365 1.415.875m-1.415-.875V15m0 6.125c-.653 0-1.209-.365-1.415-.875m1.415.875V22"
      />
    </svg>
  );
};
