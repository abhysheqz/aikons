  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M7 8v2M17 8v2M7 16.5c3.5 2 6.5 2 10 0"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M12.99 2.5c-.866 1.285-2.474 5.213-2.916 9.08-.093.81-.14 1.215.117 1.538.024.03.056.066.085.094.295.288.739.288 1.627.288.486 0 .729 0 .874.131l.042.044c.128.147.12.397.102.896-.053 1.545.02 4.481 1.079 6.929"
      />
    </svg>
  );
};
