  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M12 22c5.523 0 10-4.477 10-10 0-1.19-.18-2.352-.549-3.421-.3-.871-.65-.766-1.529-.653-1.295.166-2.625-.75-2.878-2.022-.177-.887-.203-.863-1.108-.927-.873-.063-1.68-.715-1.887-1.573C13.722 2.043 13.41 2 12 2 6.477 2 2 6.477 2 12s4.477 10 10 10Z"
      />
    </svg>
  );
};
