  ...
  return (
    ...
    >
      <path
        stroke="currentColor"
        strokeWidth={1.5}
        d="m18 18.5.278-1.386c.146-.733.538-1.41.678-2.144q.045-.229.044-.47a2.5 2.5 0 1 0-4.956.47c.14.735.532 1.41.679 2.144L15 18.5m3 0h-3m3 0 2.497.666A1.92 1.92 0 0 1 22 21.04c0 .53-.43.96-.96.96h-9.08a.96.96 0 0 1-.96-.96c0-.9.625-1.679 1.503-1.874L15 18.5"
      />
      <path
        stroke="currentColor"
        strokeLinecap="round"
