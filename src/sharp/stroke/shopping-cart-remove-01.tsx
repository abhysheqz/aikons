  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="m11.502 3.5 3 3m0 0 3 3m-3-3-3 3m3-3 3-3"
      />
      <path
        stroke="currentColor"
        strokeWidth={1.5}
        d="M17.31 19H6.506c0-2.429 2.072-3.048 3.08-2.99h5.936c5.197.128 6.476-4.848 6.476-9.49a.01.01 0 0 0-.01-.009l-2.006.01M6.51 6.51l2.496.01"
      />
    </svg>
  );
};
