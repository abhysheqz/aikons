  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M10.502 6.5h8m-4 4v-8"
      />
      <path
        stroke="currentColor"
        strokeWidth={1.5}
        d="M17.31 19H6.506c0-2.43 2.072-3.048 3.08-2.99h5.936c5.197.128 6.476-4.848 6.476-9.49a.01.01 0 0 0-.01-.01h-1.817m-13.66 0h2.466m1.525.01 7.963-.01"
      />
    </svg>
  );
};
