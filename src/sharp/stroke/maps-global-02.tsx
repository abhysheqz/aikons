  ...
  return (
    ...
    >
      ...
      <path
        stroke="currentColor"
        strokeWidth={1.5}
        d="M18.5 7a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0Z"
      />
      <path
        stroke="currentColor"
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M17 2c-2.761 0-5 2.17-5 4.848 0 1.531.625 2.722 1.875 3.785.881.75 2.484 2.358 3.125 3.367.673-.99 2.244-2.617 3.125-3.367C21.375 9.57 22 8.38 22 6.848 22 4.171 19.761 2 17 2Z"
      />
    </svg>
  );
};
