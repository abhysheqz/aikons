...
> = ({ size = 24, ...props }) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M1.25 4a2.75 2.75 0 1 1 5.5 0 2.75 2.75 0 0 1-5.5 0M17.25 4a2.75 2.75 0 1 1 5.5 0 2.75 2.75 0 0 1-5.5 0M17.25 20a2.75 2.75 0 1 1 5.5 0 2.75 2.75 0 0 1-5.5 0M1.25 20a2.75 2.75 0 1 1 5.5 0 2.75 2.75 0 0 1-5.5 0M11.665 7.08a.75.75 0 0 1 .67 0l5 2.5a.75.75 0 0 1 0 1.34l-5 2.5a.75.75 0 0 1-.67 0l-5-2.5a.75.75 0 0 1 0-1.34z"
      />
      <path
        fill="currentColor"
        fillRule="evenodd"
