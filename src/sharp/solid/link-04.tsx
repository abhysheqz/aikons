  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M7.592 9.424c1.825-1.899 4.8-1.899 6.625 0q.368.385.636.826l-1.706 1.042a2.8 2.8 0 0 0-.372-.482 2.565 2.565 0 0 0-3.741 0l-3.24 3.371c-1.059 1.103-1.059 2.906 0 4.009a2.565 2.565 0 0 0 3.741 0l.714-.743 1.442 1.386-.713.743a4.564 4.564 0 0 1-6.626 0c-1.803-1.877-1.803-4.904 0-6.78z"
        clipRule="evenodd"
      />
    </svg>
  );
